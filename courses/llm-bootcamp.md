...
layout: course
title: "LLM Bootcamp"
permalink: /courses/llm-bootcamp/
course_track: "AI / LLM"
description: "Transformers, fine-tuning, RAG, and LLMOps."
toc:
  - id: "module-1-foundations-of-large-language-models"
    label: "Module 1: Foundations of Large Language Models"
  - id: "module-2-pre-trained-llms-under-the-hood"
    label: "Module 2: Pre-trained LLMs – Under the Hood"
  - id: "module-3-prompting-fine-tuning"
    label: "Module 3: Prompting & Fine-Tuning"
  - id: "module-4-building-with-llms"
    label: "Module 4: Building with LLMs"
  - id: "module-5-advanced-topics-deployment"
    label: "Module 5: Advanced Topics & Deployment"
  - id: "capstone-projects-pick-one"
    label: "Capstone Projects (Pick One)"
  - id: "bonus-chapter-becoming-an-llm-engineer"
    label: "Bonus Chapter: Becoming an LLM Engineer"
---
