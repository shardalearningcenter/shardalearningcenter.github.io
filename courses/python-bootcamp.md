...
permalink: /courses/python-bootcamp/
course_track: "Python"
description: "Learn Python by building real apps."
toc:
  - id: "module-1-python-fundamentals"
    label: "Module 1: Python Fundamentals"
  - id: "module-2-control-flow-data-structures"
    label: "Module 2: Control Flow + Data Structures"
  - id: "module-3-file-handling-oop"
    label: "Module 3: File Handling + OOP"
  - id: "module-4-real-apps-with-external-libraries"
    label: "Module 4: Real Apps with External Libraries"
  - id: "bonus"
    label: "Bonus"
---
